...
/**
 * Button - nút bấm dùng chung toàn hệ thống. Hỗ trợ nhiều biến thể màu
 * (variant) và kích thước (size), có thể "hoá thân" thành thẻ khác (Link,...)
 * qua prop `asChild` (dùng Radix Slot) để giữ đúng style Button nhưng render
 * ra đúng phần tử HTML mong muốn (ví dụ <a> khi bọc trong next/link).
 */
